...
export const FinalPartido = (props) => {
  let { momento, equipo1, equipo2, escudo1, escudo2, puntaje1, puntaje2, deporte, imgPartido } = props



  const frame = useCurrentFrame();

  const oFondo = interpolate(frame, [0, 5], [0, 1], {
  ...
  return (
    <div style={{ backgroundColor: '#171717' }}>
      <div style={{ opacity: `${oFondo}`, position: 'relative', height: '1920px', width: '1080px', background: `url(${deporte}) center center /cover`, backgroundColor: '#171717' }}>
        <div id="divFinalPartido" style={{ clipPath: `inset(0 ${desplazamientoXFinal}% 0 0)` }}><p>{momento}</p></div>
